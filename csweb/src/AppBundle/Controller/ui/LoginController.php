...
class LoginController extends Controller {
    ...
    public function loginAction(Request $request) {
        ...
        $this->logger->debug('Response is: ' . $response->getStatusCode());
        ...
        if (isset($jsonResponse['error_description'])) {
            ...
            $this->logger->info('The login user  is  ' . print_r($user, true));
    ...
    public function canUserLogin($user) {
        ...
        $this->logger->debug('The user  is  ' . print_r($user, true));
